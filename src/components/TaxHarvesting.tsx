  ...
  return (
    <div className="text-white">
      <div className="flex items-center mb-4">
        ...
        <a href="#" className="text-blue-500 text-sm hover:underline">How it works?</a>
      </div>
      
      <div 
        className="flex items-center justify-between p-4 rounded mb-4 cursor-pointer bg-[#131823] border border-[#1e293b]"
      ...
      {disclaimerOpen && (
        <div className="bg-[#131823] border border-[#1e293b] p-4 rounded mb-4">
...
const PreHarvesting = () => {
  return (
    <div className="flex-1 bg-[#131823] rounded-lg p-5 border border-[#1e293b]">
...
const AfterHarvesting = () => {
  return (
    <div className="flex-1 bg-[#1376f4] bg-opacity-20 rounded-lg p-5 border border-[#1e293b]">
      ...
      <div className="flex items-center mt-4 bg-yellow-500 bg-opacity-20 p-2 rounded">
        <span className="text-yellow-400 text-sm">🔥 You are going to save upto $ 862</span>
      </div>
    </div>
  );
};
